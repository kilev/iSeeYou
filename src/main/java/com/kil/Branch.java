...
class Branch {
    ...
    public Branch(int node1, int node2, double factual_voltage_Re1, double factual_voltage_Im1, double factual_voltage_Re2, double factual_voltage_Im2, int max_amperage) {
        this.nodes[0] = node1;
        this.nodes[1] = node2;
